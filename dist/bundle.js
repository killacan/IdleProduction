...
var Game = /*#__PURE__*/function () {
  function Game(el, iro, num, build, info, sell, iroing, steing, music, copore, coping, copwire, toolsnum, buildcost, dots, unlimitedPower, powerCost, selebldg, bldicon) {
  ...
  _createClass(Game, [{
    ...
    value: function tick() {
      ...
      setInterval(function () {
        ...
        _this.map.setupBoard();

        if (_this.map.totalPower >= 0) {
        ...
        Object.values(this.map.allBuildings).flat().forEach(function (building) {
          ...
          rssArr.forEach(function (sub) {
            if (sub[0] === "ironOre") {
              ...
              _this2.map.money += Math.floor(sub[1] * 1.1 * marketfactor);
            } else if (sub[0] === "ironIngots") {
              building.resources["ironIngots"] = 0;
              _this2.map.money += Math.floor(sub[1] * 7 * marketfactor);
            } else if (sub[0] === "steelIngots") {
              building.resources["steelIngots"] = 0;
              _this2.map.money += Math.floor(sub[1] * 85 * marketfactor);
            } else if (sub[0] === "copperOre") {
              building.resources["copperOre"] = 0;
              _this2.map.money += Math.floor(sub[1] * 9 * marketfactor);
            } else if (sub[0] === "copperIngots") {
              building.resources["copperIngots"] = 0;
              _this2.map.money += Math.floor(sub[1] * 90 * marketfactor);
            } else if (sub[0] === "copperWire") {
              building.resources["copperWire"] = 0;
              _this2.map.money += Math.floor(sub[1] * 200 * marketfactor);
            } else if (sub[0] === "tools") {
              building.resources["tools"] = 0;
              _this2.map.money += Math.floor(sub[1] * 450 * marketfactor);
            }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* Box sizing rules */\n*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n/* Remove default margin */\nbody,\nh1,\nh2,\nh3,\nh4,\np,\nfigure,\nblockquote,\ndl,\ndd {\n  margin: 0;\n}\n\n/* Remove list styles on ul, ol elements with a list role, which suggests default styling will be removed */\nul,\nol {\n  list-style: none;\n}\n\n/* Set core body defaults */\nbody {\n  min-height: 100vh;\n  text-rendering: optimizeSpeed;\n  line-height: 1.5;\n}\n\n/* A elements that don't have a class get default styles */\na:not([class]) {\n  text-decoration-skip-ink: auto;\n}\n\n/* Make images easier to work with */\nimg,\npicture {\n  max-width: 100%;\n  display: block;\n}\n\n/* Inherit fonts for inputs and buttons */\ninput,\nbutton,\ntextarea,\nselect {\n  font: inherit;\n}\n\n/* Remove all animations, transitions and smooth scroll for people that prefer not to see them */\n@media (prefers-reduced-motion: reduce) {\n  html:focus-within {\n    scroll-behavior: auto;\n  }\n  *,\n*::before,\n*::after {\n    animation-duration: 0.01ms !important;\n    animation-iteration-count: 1 !important;\n    transition-duration: 0.01ms !important;\n    scroll-behavior: auto !important;\n  }\n}\n.nav {\n  min-width: 980px;\n}\n\n.main-nav {\n  display: grid;\n  grid-template-columns: 1fr 180px 1fr 620px 1fr 180px 1fr;\n  justify-content: space-between;\n  margin: 0 auto;\n  background-color: #ACBEBE;\n}\n\n.main-title {\n  display: flex;\n  grid-column: 4;\n  justify-content: center;\n}\n\n.main-nav > ul {\n  display: flex;\n  flex-direction: row;\n  justify-content: end;\n  align-items: flex-end;\n}\n\n.div-box {\n  grid-column: 2;\n  width: auto;\n  margin: auto;\n}\n\n.logo-list {\n  grid-column: 6;\n}\n\n.main-nav li {\n  margin: 10px;\n  text-decoration: none;\n}\n\na {\n  text-decoration: none;\n  color: #20232A;\n}\n\n.main-nav h2 {\n  margin: 20px;\n}\n\n.logo {\n  width: 34px;\n  height: 34px;\n  margin-right: 20px;\n}\n\n.resources-bar {\n  display: flex;\n  justify-content: space-between;\n  margin: 0 auto;\n  background: -webkit-linear-gradient(#ddfafa, #2c4a52);\n  opacity: 0.7;\n}\n\n.resources-bar > ul {\n  flex-direction: row;\n  justify-content: end;\n  align-items: flex-end;\n}\n\n.rss-left {\n  width: 50%;\n  text-align: center;\n}\n\n.rss-right {\n  width: 50%;\n  text-align: center;\n}\n\n.rss-left > ul {\n  display: flex;\n  flex-direction: row;\n  justify-content: end;\n}\n.rss-left > ul li {\n  padding: 10px;\n}\n\n.rss-right > ul {\n  display: flex;\n  flex-direction: row;\n}\n.rss-right > ul li {\n  padding: 10px;\n}\n\n.tutorial-holder1 {\n  display: flex;\n  justify-content: center;\n  grid-column: 1/8;\n  grid-row: 1;\n  z-index: 2;\n  width: 100%;\n  height: 100%;\n}\n.tutorial-holder1 #box-wrap {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: column;\n  padding-top: 10px;\n  margin: auto auto;\n  margin-top: 100px;\n  height: 200px;\n  width: 600px;\n  background: #fff;\n}\n.tutorial-holder1 #box-wrap #tutorial-text {\n  padding: 10px;\n  padding-left: 30px;\n  padding-right: 30px;\n}\n.tutorial-holder1 #box-wrap p {\n  margin-left: 30px;\n  margin-right: 30px;\n}\n.tutorial-holder1 #box-wrap #tut-button1 {\n  height: 40px;\n  width: 80px;\n  justify-content: center;\n  margin-bottom: 10px;\n}\n\n.tutorial-holder2 {\n  display: flex;\n  justify-content: center;\n  grid-column: 1/8;\n  grid-row: 1;\n  z-index: 2;\n  width: 100%;\n  height: 100%;\n}\n.tutorial-holder2 #box-wrap {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: column;\n  padding-top: 10px;\n  margin-right: 40%;\n  margin-top: 100px;\n  height: 200px;\n  width: 600px;\n  background: #fff;\n}\n.tutorial-holder2 #box-wrap #tutorial-text {\n  padding: 10px;\n  padding-left: 30px;\n  padding-right: 30px;\n}\n.tutorial-holder2 #box-wrap p {\n  margin-left: 30px;\n  margin-right: 30px;\n}\n.tutorial-holder2 #box-wrap #tut-button2 {\n  height: 40px;\n  width: 80px;\n  justify-content: center;\n  margin-bottom: 10px;\n}\n\n.tutorial-holder3 {\n  display: flex;\n  justify-content: center;\n  grid-column: 1/8;\n  grid-row: 1;\n  z-index: 2;\n  width: 100%;\n  height: 100%;\n}\n.tutorial-holder3 #box-wrap {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: column;\n  padding-top: 10px;\n  height: 200px;\n  width: 600px;\n  background: #fff;\n}\n.tutorial-holder3 #box-wrap #tutorial-text {\n  padding: 10px;\n  padding-left: 30px;\n  padding-right: 30px;\n}\n.tutorial-holder3 #box-wrap p {\n  margin-left: 30px;\n  margin-right: 30px;\n}\n.tutorial-holder3 #box-wrap #tut-button3 {\n  height: 40px;\n  width: 80px;\n  justify-content: center;\n  margin-bottom: 10px;\n}\n\n.tutorial-holder4 {\n  display: flex;\n  justify-content: center;\n  grid-column: 1/8;\n  grid-row: 1;\n  z-index: 2;\n  width: 100%;\n  height: 100%;\n}\n.tutorial-holder4 #box-wrap {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: column;\n  padding-top: 10px;\n  margin-right: 50%;\n  height: 200px;\n  width: 600px;\n  background: #fff;\n}\n.tutorial-holder4 #box-wrap #tutorial-text {\n  padding: 10px;\n  padding-left: 30px;\n  padding-right: 30px;\n}\n.tutorial-holder4 #box-wrap p {\n  margin-left: 30px;\n  margin-right: 30px;\n}\n.tutorial-holder4 #box-wrap #tut-button4 {\n  height: 40px;\n  width: 80px;\n  justify-content: center;\n  margin-bottom: 10px;\n}\n\n.hidden {\n  display: none;\n}\n\n#game-canvas, #builder-canvas, #info-canvas {\n  background-color: #ACBEBE;\n  border-radius: 10px;\n}\n\n.container {\n  display: grid;\n  grid-template-columns: 1fr 180px 1fr 620px 1fr 180px 1fr;\n}\n\n.grid-container {\n  display: grid;\n  width: 620px;\n  height: 620px;\n  grid-column: 4;\n  grid-row: 1;\n  grid-template-columns: 20% 20% 20% 20% 20%;\n  grid-template-rows: 45px 10% 20% 20% 20% 20%;\n}\n\n#game-canvas {\n  grid-column: 1;\n  grid-row: 1;\n}\n\n.build-area-title {\n  width: 100%;\n  padding-top: 10px;\n  grid-column: 1/6;\n  grid-row: 1;\n  display: flex;\n  justify-content: center;\n}\n\n.info-panel {\n  display: grid;\n  grid-column: 6;\n  grid-row: 1;\n  grid-template-columns: 33% 33% 33%;\n  grid-template-rows: 50px 250px 50px 50px;\n}\n.info-panel #info-canvas {\n  grid-column: 1/1;\n  grid-row: 1;\n  width: 180px;\n}\n.info-panel h3 {\n  width: 180px;\n  grid-column: 1/4;\n  grid-row: 1;\n  z-index: 1;\n  display: flex;\n  justify-content: center;\n  padding-top: 10px;\n}\n.info-panel .description-holder {\n  grid-column: 1/4;\n  grid-row: 2/2;\n  padding: 30px;\n  padding-left: 10px;\n  padding-right: 10px;\n  background-color: #D4DDe1;\n}\n.info-panel .cost-holder {\n  display: flex;\n  grid-column: 1/4;\n  grid-row: 3;\n  padding-left: 10px;\n  padding-right: 10px;\n  background-color: #D4DDe1;\n}\n.info-panel .power-cost-holder {\n  display: flex;\n  grid-column: 1/4;\n  grid-row: 4;\n  padding-left: 10px;\n  padding-right: 10px;\n  background-color: #D4DDe1;\n}\n\n.builder-menu {\n  display: grid;\n  grid-column: 2;\n  grid-row: 1;\n  grid-template-columns: 33% 33% 33%;\n}\n.builder-menu #builder-canvas {\n  grid-column: 1/1;\n  grid-row: 1;\n  width: 180px;\n}\n.builder-menu h3 {\n  grid-column: 1/4;\n  grid-row: 1;\n  z-index: 1;\n  display: flex;\n  justify-content: center;\n  padding-top: 10px;\n  height: 20px;\n}\n.builder-menu ul {\n  grid-column: 1;\n  grid-row: 1;\n  width: 180px;\n  display: flex;\n  flex-wrap: wrap;\n  list-style: none;\n  padding-top: 30px;\n  padding-left: 0px;\n  z-index: 1;\n}\n.builder-menu ul li {\n  margin: 10px auto;\n  width: 70px;\n  height: 70px;\n  border-style: solid;\n  border: 1px solid #A01D26;\n  z-index: 2;\n  cursor: pointer;\n}\n.builder-menu ul li:hover {\n  background-color: gray;\n  transition-duration: 300ms;\n  transform: scale(1.1);\n}\n.builder-menu ul .selected {\n  background-color: gray;\n  transition-duration: 300ms;\n  transform: scale(1.1);\n}\n\n.grid {\n  grid-column: 1/6;\n  grid-row: 2;\n}\n\n.grid > ul {\n  width: 620px;\n  display: flex;\n  flex-wrap: wrap;\n  list-style: none;\n  padding: 0%;\n  margin-top: 10px;\n  margin-left: 10px;\n}\n\n.grid li {\n  width: 60px;\n  height: 60px;\n  justify-content: center;\n  cursor: pointer;\n}\n\n.grid li:hover, .builder-menu li:hover {\n  background-color: gray;\n  background-color: gray;\n  transition-duration: 300ms;\n  transform: scale(1.1);\n  border: 1px solid #A01D26;\n}\n\n#circle-canvas {\n  width: 620px;\n  height: 620px;\n  grid-column: 1;\n  grid-row: 1;\n  pointer-events: none;\n}\n\nbutton {\n  cursor: pointer;\n}\n\nbody {\n  background-color: #2c4a52;\n  font-family: \"Roboto\", sans-serif;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss","webpack://./src/styles/base/reset.scss","webpack://./src/styles/components/_main_nav.scss","webpack://./src/styles/components/_resource_bar.scss","webpack://./src/styles/components/_welcome_message.scss","webpack://./src/styles/components/_grid.scss"],"names":[],"mappings":"AAAQ,qBAAA;ACCR;;;EAGE,sBAAA;ADCF;;ACEA,0BAAA;AACA;;;;;;;;;;EAUE,SAAA;ADCF;;ACEA,2GAAA;AACA;;EAEE,gBAAA;ADCF;;ACEA,2BAAA;AACA;EACE,iBAAA;EACA,6BAAA;EACA,gBAAA;ADCF;;ACEA,0DAAA;AACA;EACE,8BAAA;ADCF;;ACEA,oCAAA;AACA;;EAEE,eAAA;EACA,cAAA;ADCF;;ACEA,yCAAA;AACA;;;;EAIE,aAAA;ADCF;;ACEA,gGAAA;AACA;EACE;IACC,qBAAA;EDCD;ECEA;;;IAGE,qCAAA;IACA,uCAAA;IACA,sCAAA;IACA,gCAAA;EDAF;AACF;AE9DA;EACI,gBAAA;AFgEJ;;AE9DA;EACI,aAAA;EACA,wDAAA;EACA,8BAAA;EACA,cAAA;EACA,yBAAA;AFiEJ;;AE9DA;EACI,aAAA;EACA,cAAA;EACA,uBAAA;AFiEJ;;AE9DA;EACI,aAAA;EACA,mBAAA;EACA,oBAAA;EACA,qBAAA;AFiEJ;;AE7DA;EACI,cAAA;EACA,WAAA;EACA,YAAA;AFgEJ;;AE1DA;EACI,cAAA;AF6DJ;;AE1DA;EACI,YAAA;EACA,qBAAA;AF6DJ;;AE1DA;EACI,qBAAA;EACA,cAAA;AF6DJ;;AE1DA;EACI,YAAA;AF6DJ;;AE1DA;EACI,WAAA;EACA,YAAA;EACA,kBAAA;AF6DJ;;AGpHA;EACI,aAAA;EACA,8BAAA;EACA,cAAA;EACA,qDAAA;EACA,YAAA;AHuHJ;;AGnHA;EAEI,mBAAA;EACA,oBAAA;EACA,qBAAA;AHqHJ;;AGjHA;EAEI,UAAA;EACA,kBAAA;AHmHJ;;AGhHA;EAEI,UAAA;EACA,kBAAA;AHkHJ;;AG/GA;EACI,aAAA;EACA,mBAAA;EACA,oBAAA;AHkHJ;AGhHI;EACI,aAAA;AHkHR;;AG7GA;EACI,aAAA;EACA,mBAAA;AHgHJ;AG7GI;EACI,aAAA;AH+GR;;AIlKA;EACI,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,YAAA;AJqKJ;AInKI;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,sBAAA;EACA,iBAAA;EACA,iBAAA;EACA,iBAAA;EACA,aAAA;EACA,YAAA;EACA,gBAAA;AJqKR;AInKQ;EACI,aAAA;EACA,kBAAA;EACA,mBAAA;AJqKZ;AIlKQ;EACI,iBAAA;EACA,kBAAA;AJoKZ;AIjKQ;EACI,YAAA;EACA,WAAA;EACA,uBAAA;EACA,mBAAA;AJmKZ;;AI5JA;EACI,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,YAAA;AJ+JJ;AI7JI;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,sBAAA;EACA,iBAAA;EACA,iBAAA;EACA,iBAAA;EACA,aAAA;EACA,YAAA;EACA,gBAAA;AJ+JR;AI7JQ;EACI,aAAA;EACA,kBAAA;EACA,mBAAA;AJ+JZ;AI5JQ;EACI,iBAAA;EACA,kBAAA;AJ8JZ;AI3JQ;EACI,YAAA;EACA,WAAA;EACA,uBAAA;EACA,mBAAA;AJ6JZ;;AItJA;EACI,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,YAAA;AJyJJ;AIvJI;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,sBAAA;EACA,iBAAA;EACA,aAAA;EACA,YAAA;EACA,gBAAA;AJyJR;AIvJQ;EACI,aAAA;EACA,kBAAA;EACA,mBAAA;AJyJZ;AItJQ;EACI,iBAAA;EACA,kBAAA;AJwJZ;AIrJQ;EACI,YAAA;EACA,WAAA;EACA,uBAAA;EACA,mBAAA;AJuJZ;;AIhJA;EACI,aAAA;EACA,uBAAA;EACA,gBAAA;EACA,WAAA;EACA,UAAA;EACA,WAAA;EACA,YAAA;AJmJJ;AIjJI;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,sBAAA;EACA,iBAAA;EACA,iBAAA;EACA,aAAA;EACA,YAAA;EACA,gBAAA;AJmJR;AIjJQ;EACI,aAAA;EACA,kBAAA;EACA,mBAAA;AJmJZ;AIhJQ;EACI,iBAAA;EACA,kBAAA;AJkJZ;AI/IQ;EACI,YAAA;EACA,WAAA;EACA,uBAAA;EACA,mBAAA;AJiJZ;;AIzIA;EACI,aAAA;AJ4IJ;;AKjSA;EACI,yBAtBc;EAuBd,mBAAA;ALoSJ;;AK9RA;EACI,aAAA;EACA,wDAAA;ALiSJ;;AKxRA;EACI,aAAA;EACA,YAAA;EACA,aAAA;EACA,cAAA;EACA,WAAA;EAEA,0CAAA;EACA,4CAAA;AL0RJ;;AKvRA;EACI,cAAA;EACA,WAAA;AL0RJ;;AKjRA;EACI,WAAA;EACA,iBAAA;EACA,gBAAA;EACA,WAAA;EACA,aAAA;EACA,uBAAA;ALoRJ;;AKjRA;EACI,aAAA;EACA,cAAA;EACA,WAAA;EACA,kCAAA;EACA,wCAAA;ALoRJ;AKnRI;EACI,gBAAA;EACA,WAAA;EACA,YAAA;ALqRR;AKnRI;EACI,YAAA;EACA,gBAAA;EACA,WAAA;EACA,UAAA;EACA,aAAA;EACA,uBAAA;EACA,iBAAA;ALqRR;AKnRI;EACI,gBAAA;EACA,aAAA;EACA,aAAA;EACA,kBAAA;EACA,mBAAA;EACA,yBAhGS;ALqXjB;AKnRI;EACI,aAAA;EAEA,gBAAA;EACA,WAAA;EACA,kBAAA;EACA,mBAAA;EACA,yBAzGS;AL6XjB;AKlRI;EACI,aAAA;EAEA,gBAAA;EACA,WAAA;EACA,kBAAA;EACA,mBAAA;EACA,yBAlHS;ALqYjB;;AK/QA;EACI,aAAA;EACA,cAAA;EACA,WAAA;EACA,kCAAA;ALkRJ;AKhRI;EACI,gBAAA;EACA,WAAA;EACA,YAAA;ALkRR;AK/QI;EACI,gBAAA;EACA,WAAA;EACA,UAAA;EAGA,aAAA;EACA,uBAAA;EACA,iBAAA;EACA,YAAA;AL+QR;AK5QI;EACI,cAAA;EACA,WAAA;EACA,YAAA;EACA,aAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,iBAAA;EACA,UAAA;AL8QR;AK5QQ;EACI,iBAAA;EACA,WAAA;EACA,YAAA;EACA,mBAAA;EACA,yBAAA;EACA,UAAA;EACA,eAAA;AL8QZ;AK3QQ;EACI,sBAAA;EACA,0BAAA;EACA,qBAAA;AL6QZ;AK1QQ;EACI,sBAAA;EACA,0BAAA;EACA,qBAAA;AL4QZ;;AKtQA;EAQI,gBAAA;EACA,WAAA;ALkQJ;;AK9PA;EACI,YAAA;EACA,aAAA;EACA,eAAA;EACA,gBAAA;EACA,WAAA;EACA,gBAAA;EACA,iBAAA;ALiQJ;;AK7PA;EACI,WAAA;EACA,YAAA;EACA,uBAAA;EACA,eAAA;ALgQJ;;AK7PA;EACI,sBAAA;EACA,sBAAA;EACA,0BAAA;EACA,qBAAA;EACA,yBAAA;ALgQJ;;AK5PA;EACI,YAAA;EACA,aAAA;EACA,cAAA;EACA,WAAA;EACA,oBAAA;AL+PJ;;AA7cA;EACE,eAAA;AAgdF;;AA7cA;EACE,yBAfc;EAgBd,iCAAA;AAgdF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');\n\n@import \"base/reset.scss\";\n\n@import \"components/_main_nav.scss\";\n@import \"components/resource_bar.scss\";\n@import \"components/_welcome_message.scss\";\n@import \"components/grid.scss\";\n\n$primary-color: #2c4a52;\n$secondary-color: #ACBEBE;\n$tertiary-color: #F4F4EF;\n$highlights: #A01D26;\n// $box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n\n// * {\n//   box-sizing: border-box;\n// }\n\nbutton {\n  cursor: pointer;\n}\n\nbody {\n  background-color: $primary-color;\n  font-family: 'Roboto', sans-serif;\n//   display: flex;\n//   flex-direction: column;\n//   align-items: center;\n//   justify-content: center;\n//   height: 100vh;\n//   overflow: hidden;\n//   margin: 0;\n//   padding: 20px;\n}\n\n\n\n// .container {\n//   background-color: $secondary-color;\n//   border-radius: 10px;\n//   box-shadow: $box-shadow;\n//   padding: 50px 20px;\n//   text-align: center;\n//   max-width: 100%;\n//   width: 800px;\n// }\n\n// h2 {\n//   margin: 0;\n//   opacity: 0.5;\n//   letter-spacing: 2px;\n// }\n\n// img {\n//   width: 100px;\n//   margin-bottom: 20px;\n// }\n\n// .joke {\n//   font-size: 30px;\n//   letter-spacing: 1px;\n//   line-height: 40px;\n//   margin: 50px auto;\n//   max-width: 600px;\n// }\n\n// .btn {\n//   background-color: $primary-color;\n//   color: $secondary-color;\n//   border: 0;\n//   border-radius: 10px;\n//   box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n//   padding: 14px 40px;\n//   font-size: 16px;\n//   cursor: pointer;\n\n//   &:active {\n//     transform: scale(0.98);\n//   }\n\n//   &:focus {\n//     outline: 0;\n//   }\n// }\n\n","/* Box sizing rules */\n*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n/* Remove default margin */\nbody,\nh1,\nh2,\nh3,\nh4,\np,\nfigure,\nblockquote,\ndl,\ndd {\n  margin: 0;\n}\n\n/* Remove list styles on ul, ol elements with a list role, which suggests default styling will be removed */\nul,\nol {\n  list-style: none;\n}\n\n/* Set core body defaults */\nbody {\n  min-height: 100vh;\n  text-rendering: optimizeSpeed;\n  line-height: 1.5;\n}\n\n/* A elements that don't have a class get default styles */\na:not([class]) {\n  text-decoration-skip-ink: auto;\n}\n\n/* Make images easier to work with */\nimg,\npicture {\n  max-width: 100%;\n  display: block;\n}\n\n/* Inherit fonts for inputs and buttons */\ninput,\nbutton,\ntextarea,\nselect {\n  font: inherit;\n}\n\n/* Remove all animations, transitions and smooth scroll for people that prefer not to see them */\n@media (prefers-reduced-motion: reduce) {\n  html:focus-within {\n   scroll-behavior: auto;\n  }\n  \n  *,\n  *::before,\n  *::after {\n    animation-duration: 0.01ms !important;\n    animation-iteration-count: 1 !important;\n    transition-duration: 0.01ms !important;\n    scroll-behavior: auto !important;\n  }\n}\n","$primary-color: #20232A;\n$secondary-color: #ACBEBE;\n$tertiary-color: #F4F4EF;\n$highlights: #A01D26;\n\n.nav {\n    min-width: 980px;\n}\n.main-nav {\n    display: grid;\n    grid-template-columns: 1fr 180px 1fr 620px 1fr 180px 1fr;\n    justify-content: space-between;\n    margin: 0 auto;\n    background-color: #ACBEBE;\n}\n\n.main-title {\n    display: flex;\n    grid-column: 4;\n    justify-content: center;\n}\n\n.main-nav > ul {\n    display: flex;\n    flex-direction: row;\n    justify-content: end;\n    align-items: flex-end;\n\n}\n\n.div-box {\n    grid-column: 2;\n    width: auto;\n    margin: auto;\n    // button {\n    //     margin: auto; \n    // }\n}\n\n.logo-list {\n    grid-column: 6;\n}\n\n.main-nav li {\n    margin: 10px;\n    text-decoration: none;\n}\n\na {\n    text-decoration: none;\n    color: #20232A;\n}\n\n.main-nav h2 {\n    margin: 20px;\n}\n\n.logo {\n    width: 34px;\n    height: 34px;\n    margin-right: 20px;\n}","$primary-color: #2c4a52;\n$secondary-color: #ddfafa;\n$tertiary-color: #e4e4da;\n$highlights: #A01D26;\n\n.resources-bar {\n    display: flex;\n    justify-content: space-between;\n    margin: 0 auto;\n    background: -webkit-linear-gradient($secondary-color,$primary-color);\n    opacity: .7;\n  \n}\n\n.resources-bar > ul {\n    // display: flex;\n    flex-direction: row;\n    justify-content: end;\n    align-items: flex-end;\n\n}\n\n.rss-left {\n    // justify-content: space-between;\n    width: 50%;\n    text-align: center;\n}\n\n.rss-right {\n    // justify-content: end;\n    width: 50%;\n    text-align: center;\n}\n\n.rss-left > ul {\n    display: flex;\n    flex-direction: row;\n    justify-content: end;\n\n    li {\n        padding: 10px;\n    }\n\n}\n\n.rss-right > ul {\n    display: flex;\n    flex-direction: row;\n    // justify-content: end;\n\n    li {\n        padding: 10px;\n    }\n\n}\n",".tutorial-holder1 {\n    display: flex;\n    justify-content: center;\n    grid-column: 1/8;\n    grid-row: 1;\n    z-index: 2;\n    width: 100%;\n    height: 100%;\n    \n    #box-wrap {\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        flex-direction: column;\n        padding-top: 10px;\n        margin: auto auto;\n        margin-top: 100px;\n        height: 200px;\n        width: 600px;\n        background: #fff;\n\n        #tutorial-text {\n            padding: 10px;\n            padding-left: 30px;\n            padding-right: 30px;\n        }\n\n        p {\n            margin-left: 30px;\n            margin-right: 30px;\n        }\n\n        #tut-button1 {\n            height: 40px;\n            width: 80px;\n            justify-content: center;\n            margin-bottom: 10px;\n\n        }\n    }\n\n}\n\n.tutorial-holder2 {\n    display: flex;\n    justify-content: center;\n    grid-column: 1/8;\n    grid-row: 1;\n    z-index: 2;\n    width: 100%;\n    height: 100%;\n    \n    #box-wrap {\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        flex-direction: column;\n        padding-top: 10px;\n        margin-right: 40%;\n        margin-top: 100px;\n        height: 200px;\n        width: 600px;\n        background: #fff;\n\n        #tutorial-text {\n            padding: 10px;\n            padding-left: 30px;\n            padding-right: 30px;\n        }\n\n        p {\n            margin-left: 30px;\n            margin-right: 30px;\n        }\n\n        #tut-button2 {\n            height: 40px;\n            width: 80px;\n            justify-content: center;\n            margin-bottom: 10px;\n\n        }\n    }\n\n}\n\n.tutorial-holder3 {\n    display: flex;\n    justify-content: center;\n    grid-column: 1/8;\n    grid-row: 1;\n    z-index: 2;\n    width: 100%;\n    height: 100%;\n    \n    #box-wrap {\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        flex-direction: column;\n        padding-top: 10px;\n        height: 200px;\n        width: 600px;\n        background: #fff;\n\n        #tutorial-text {\n            padding: 10px;\n            padding-left: 30px;\n            padding-right: 30px;\n        }\n\n        p {\n            margin-left: 30px;\n            margin-right: 30px;\n        }\n\n        #tut-button3 {\n            height: 40px;\n            width: 80px;\n            justify-content: center;\n            margin-bottom: 10px;\n\n        }\n    }\n\n}\n\n.tutorial-holder4 {\n    display: flex;\n    justify-content: center;\n    grid-column: 1/8;\n    grid-row: 1;\n    z-index: 2;\n    width: 100%;\n    height: 100%;\n    \n    #box-wrap {\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        flex-direction: column;\n        padding-top: 10px;\n        margin-right: 50%;\n        height: 200px;\n        width: 600px;\n        background: #fff;\n\n        #tutorial-text {\n            padding: 10px;\n            padding-left: 30px;\n            padding-right: 30px;\n        }\n\n        p {\n            margin-left: 30px;\n            margin-right: 30px;\n        }\n\n        #tut-button4 {\n            height: 40px;\n            width: 80px;\n            justify-content: center;\n            margin-bottom: 10px;\n\n        }\n    }\n\n}\n\n\n.hidden {\n    display: none;\n}\n\n","$primary-color: #20232A;\n$secondary-color: #ACBEBE;\n$tertiary-color: #D4DDe1;\n$highlights: #A01D26;\n\n// Understated and versatile\n// stormy sea   #335252\n// fog          #D4DDe1\n// Rust         #AA4B41\n// Charcoal     #2D3033\n\n// Hazy Grays\n// Blue Green #2c4a52\n// Waterway    #537072\n// Haze    #8E9B97\n// Smog    #F4EBDB\n\n// #20232A Ink\n// #ACBEBE Aluminum\n// #F4F4EF Paper\n// #A01D26 Ruby Red\n\n#game-canvas, #builder-canvas, #info-canvas {\n    background-color: $secondary-color;\n    border-radius: 10px;\n    // display: flex;\n    // grid-template-columns: 65px 1fr 65px;\n    // grid-template-rows: 100px 100px 100px;\n}\n\n.container {\n    display: grid;\n    grid-template-columns: 1fr 180px 1fr 620px 1fr 180px 1fr;\n    // justify-content: space-between;\n    // position: absolute;\n    // width: 100%;\n    // left: 0;\n    // right: 0;\n    // margin: auto;\n}\n\n.grid-container {\n    display: grid;\n    width: 620px;\n    height: 620px;\n    grid-column: 4;\n    grid-row: 1;\n    // justify-content: center;\n    grid-template-columns: 20% 20% 20% 20% 20%;\n    grid-template-rows: 45px 10% 20% 20% 20% 20%;\n}\n\n#game-canvas {\n    grid-column: 1;\n    grid-row: 1;\n    // grid-column-end: 3;\n    // position: absolute;\n    // width: 620px;\n    // left: 0;\n    // right: 0;\n    // margin: auto;\n}\n\n.build-area-title {\n    width: 100%;\n    padding-top: 10px;\n    grid-column: 1/6;\n    grid-row: 1;\n    display: flex;\n    justify-content: center;\n}\n\n.info-panel {\n    display: grid;\n    grid-column: 6;\n    grid-row: 1;\n    grid-template-columns: 33% 33% 33%;\n    grid-template-rows: 50px 250px 50px 50px;\n    #info-canvas {\n        grid-column: 1/1;\n        grid-row: 1;\n        width: 180px;\n    }\n    h3 {\n        width: 180px;\n        grid-column: 1/4;\n        grid-row: 1;\n        z-index: 1;\n        display: flex;\n        justify-content: center;\n        padding-top: 10px;\n    }\n    .description-holder {\n        grid-column: 1/4;\n        grid-row: 2/2;\n        padding: 30px;\n        padding-left: 10px;\n        padding-right: 10px;\n        background-color: $tertiary-color;\n    }\n    .cost-holder {\n        display: flex;\n        // justify-content: center;\n        grid-column: 1/4;\n        grid-row: 3;\n        padding-left: 10px;\n        padding-right: 10px;\n        background-color: $tertiary-color;\n    }\n    .power-cost-holder {\n        display: flex;\n        // justify-content: center;\n        grid-column: 1/4;\n        grid-row: 4;\n        padding-left: 10px;\n        padding-right: 10px;\n        background-color: $tertiary-color;\n    }\n}\n\n.builder-menu {\n    display: grid;\n    grid-column: 2;\n    grid-row: 1;\n    grid-template-columns: 33% 33% 33%;\n    \n    #builder-canvas {\n        grid-column: 1 / 1;\n        grid-row: 1;\n        width: 180px;\n    }\n    \n    h3 {\n        grid-column: 1/4;\n        grid-row: 1;\n        z-index: 1;\n        // -webkit-text-stroke: 1px;\n        // -webkit-text-stroke-color: white;\n        display: flex;\n        justify-content: center;\n        padding-top: 10px;\n        height: 20px;\n    }\n\n    ul {\n        grid-column: 1;\n        grid-row: 1;\n        width: 180px;\n        display: flex;\n        flex-wrap: wrap;\n        list-style: none;\n        padding-top: 30px;\n        padding-left: 0px;\n        z-index: 1;\n\n        li {\n            margin: 10px auto;\n            width: 70px;\n            height: 70px;\n            border-style: solid;\n            border: 1px solid #A01D26;\n            z-index: 2;\n            cursor: pointer;\n        }\n\n        li:hover {\n            background-color: gray;\n            transition-duration: 300ms;\n            transform: scale(1.1);\n        }\n\n        .selected {\n            background-color: gray;\n            transition-duration: 300ms;\n            transform: scale(1.1);\n        }\n    }\n\n}\n\n.grid {\n    // display: flex;\n    // position: relative;\n    // width: 0px;\n    // left: 0;\n    // right: 0;\n    // margin: auto;\n    // margin-top: 0px;\n    grid-column: 1/6;\n    grid-row: 2;\n    // grid-column-end: 4;\n}\n\n.grid > ul {\n    width: 620px;\n    display: flex;\n    flex-wrap: wrap;\n    list-style: none;\n    padding: 0%;\n    margin-top: 10px;\n    margin-left: 10px;\n    // position: absolute;\n}\n\n.grid li {\n    width: 60px;\n    height: 60px;\n    justify-content: center;\n    cursor: pointer;\n}\n\n.grid li:hover, .builder-menu li:hover {\n    background-color: gray;\n    background-color: gray;\n    transition-duration: 300ms;\n    transform: scale(1.1);\n    border: 1px solid $highlights;\n\n}\n\n#circle-canvas {\n    width: 620px;\n    height: 620px;\n    grid-column: 1; \n    grid-row: 1;\n    pointer-events: none;\n}"],"sourceRoot":""}]);
// Exports
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var bldicon = document.querySelector(".buildings"); // let ctx = canvas.getContext("2d")
  // ctx.moveTo(0, 0);
  // ctx.lineTo(200, 100);
  // ctx.stroke();
  // Box width
  ...
  var gamev = new Game(el, iro, num, bui, info, sell, iroing, steing, music, copOre, copIng, copwire, toolsnum, buildcost, dots, unlimitedPOWER, powerCost, selebldg, bldicon); // gamev.map.startingMarket()
