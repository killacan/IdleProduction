      ...
      if (this.toggle) {
        Object.values(this.map.allBuildings).flat().forEach(function (building) {
          ...
          if (_this2.map.allBuildings["market"]) {
            marketfactor += _this2.map.allBuildings["market"].length;
          }
...
var Market = /*#__PURE__*/function (_Node) {
  ...
  function Market(pos) {
    ...
    _this.name = "Market";
    _this.cost = 500;
    _this.description = "having a market makes your goods more valuable"; // this.map = this.updateRSS.bind(this)
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var tutbox = document.querySelector('.tutorial-holder'); // let ctx = canvas.getContext("2d")
  // ctx.moveTo(0, 0);
  // ctx.lineTo(200, 100);
  // ctx.stroke();
  // Box width
